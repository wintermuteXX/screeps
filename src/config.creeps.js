module.exports = {
  ...
  "transporter": {
    ...
    behaviors: ["get_energy_dropped", "get_energy_link", "get_energy_storage", "transfer_energy_extensions", "transfer_energy_spawn", "transfer_energy_storage", "transfer_energy_upgrader"]
  },
