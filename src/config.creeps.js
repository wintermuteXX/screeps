module.exports = {
  ...
  "transporter": {
    ...
    behaviors: ["find_energy_transporter", "transfer_energy_extensions", "transfer_energy_storage", "transfer_energy_spawn", "transfer_energy_links", "transfer_energy_upgrader"]
  },
  ...
  "constructor" : {
    ...
    behaviors : [ "get_energy", "repair", "build_structures", "wait_blue_flag" ]
