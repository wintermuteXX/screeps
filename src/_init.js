...
if (Creep && Creep.prototype && !Creep.prototype.behavior) {
  Object.defineProperty(Creep.prototype, "behavior", {
    get: function () {
      // Safety check: wrap in try-catch to handle creeps that don't exist yet
      try {
        // Accessing this.memory will throw if creep doesn't exist yet
        return this.memory.behavior || null;
      } catch (e) {
        // Creep doesn't exist yet (e.g., during spawning)
        return null;
      }
    },
    set: function (newBehavior) {
      ...
      try {
        ...
        // Only set target if creep exists (will be caught by try-catch if not)
        try {
          this.target = null;
        } catch (e) {
          // Ignore if target setter fails
        }
      } catch (e) {
        // Creep doesn't exist yet - ignore
      }
    },
    configurable: true,
    enumerable: false
...
if (Creep && Creep.prototype && !Creep.prototype.role) {
...
if (Creep && Creep.prototype && !Creep.prototype.target) {
 ...
 */
if (Creep && Creep.prototype && !Creep.prototype.targets) {
...
if (Source && Source.prototype && !Source.prototype.defended) {
...
if (Source && Source.prototype && !Source.prototype.container) {
...
if (Source && Source.prototype && !Source.prototype.memory) {
...
if (Structure && Structure.prototype && !Structure.prototype.container) {
...
if (Structure && Structure.prototype && !Structure.prototype.memory) {
...
if (Room && Room.prototype && !Room.prototype.mineral) {
...
if (RoomPosition && RoomPosition.prototype && !RoomPosition.prototype.freeFieldsCount) {
 ...
 */
if (Source && Source.prototype && !Source.prototype.freeSpacesCount) {
