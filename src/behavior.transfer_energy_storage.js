...
b.when = function (creep, rc) {
  ...
  console.log(storage.store[RESOURCE_ENERGY] < global.getInterval('StoreLevel4'));
  if ( creep.room.controller.level === 4 && storage.store[RESOURCE_ENERGY] < global.getInterval('StoreLevel4')) { 
      return true;
  }
